...
ai::ai_knowledge& ai_manager::game_scope_knowledge() { return game_scope_knowledge_; }

const ai::ai_knowledge& ai_manager::game_scope_knowledge() const { return game_scope_knowledge_; }
