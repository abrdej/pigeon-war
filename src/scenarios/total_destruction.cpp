...
void scenarios::create_total_destruction() {
    ...
    std::vector<std::uint32_t> wolves_indexes = {
            game_board().to_index(2, 1),
            game_board().to_index(2, 3),
            game_board().to_index(2, 5),
            game_board().to_index(2, 7),
            game_board().to_index(4, 1),
            game_board().to_index(6, 1),
            game_board().to_index(8, 1),
            game_board().to_index(10, 1),
            game_board().to_index(12, 1),
            game_board().to_index(12, 3),
            game_board().to_index(12, 5),
            game_board().to_index(12, 7)
    };
