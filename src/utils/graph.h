...
template <typename T>
void breadth_search(graph& g, const typename graph::vertex_descriptor& initial_vertex,
...
auto breadth_search(graph& g, const typename graph::vertex_descriptor& initial_vertex,
                    std::vector<T>& distances_map,
                    std::vector<typename graph::vertex_descriptor>& sequence_map,
                    Condition condition) {
  using vertex_descriptor = typename graph::vertex_descriptor;
