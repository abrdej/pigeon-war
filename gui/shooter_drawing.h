...
//
//        textures.push_back(view::bitmap_center::get_bitmap(BitmapKey::shooter));
//        textures.push_back(view::bitmap_center::get_bitmap(BitmapKey::shooter_shoot));
//    }
//
//    void set_shoot(const std::chrono::seconds& seconds) {
//        state = States::shoot;
//    }
//
