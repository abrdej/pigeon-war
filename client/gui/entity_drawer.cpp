...
entity_drawer::entity_drawer(std::uint32_t entity_id, const bitmap_key& bmt_key)
...
void entity_drawer::render_text(std::int32_t entity_health, sf::Vector2f position, std::uint32_t entity_id, sf::RenderWindow& window)
{
...
void entity_drawer::draw(sf::RenderWindow& window, std::uint32_t col, std::uint32_t row, std::int32_t health) {
